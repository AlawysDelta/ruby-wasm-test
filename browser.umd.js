(function(global, factory) {
   ...
   */
    function A(A, I, g, B) {
        return new (g || (g = Promise))((function(Q, C) {
            function E(A) {
                try {
                    i(B.next(A));
                } catch (A) {
            ...
            function i(A) {
                var I;
                A.done ? Q(A.value) : (I = A.value,
                I instanceof g ? I : new g((function(A) {
                    A(I);
                }
                ))).then(E, D);
            }
            i((B = B.apply(A, I || [])).next());
        }
        ))
    }
    function I(A, I) {
            ...
            return function(i) {
                return function(D) {
                    ...
                    E; )
                        try {
                            if (g = 1,
                            B && (Q = 2 & D[0] ? B.return : D[0] ? B.throw || ((Q = B.return) && Q.call(B),
                            0) : B.next) && !(Q = Q.call(B, D[1])).done)
                                return Q;
                            switch (B = 0,
                            Q && (D = [2 & D[0], Q.value]),
                            D[0]) {
                            ...
                            default:
                                if (!(Q = E.trys,
                                (Q = Q.length > 0 && Q[Q.length - 1]) || 6 !== D[0] && 2 !== D[0])) {
                                    E = 0;
                                    continue
                                }
    ...
    function w() {
        return 0 === i.byteLength && (i = new Uint8Array(g.memory.buffer)),
        i
    }
    function o(A, I) {
        return D.decode(w().subarray(A, A + I))
    }
    function G(A) {
        const I = Q(A);
        return function(A) {
    ...
    const k = new TextEncoder("utf-8")
      , y = "function" == typeof k.encodeInto ? function(A, I) {
        return k.encodeInto(A, I)
    }
    : function(A, I) {
        const g = k.encode(A);
        return I.set(g),
    ...
    function Y(A, I, g) {
        if (void 0 === g) {
            const g = k.encode(A)
              , B = I(g.length);
            return w().subarray(B, B + g.length).set(g),
            M = g.length,
            B
        }
        let B = A.length
        ...
        if (E !== B) {
            0 !== E && (A = A.slice(E)),
            Q = g(Q, B, B = E + 3 * A.length);
            const I = w().subarray(Q + E, Q + B);
            E += y(A, I).written;
        }
        return M = E,
        Q
    ...
    function h() {
        return 0 === a.byteLength && (a = new Int32Array(g.memory.buffer)),
        a
    }
    function F(A) {
        return null == A
    ...
    function R(A, I) {
        try {
            ...
            g.__wbindgen_exn_store(E(A));
        }
    }
    function c(A, I) {
        return w().subarray(A / 1, A / 1 + I)
    }
    function K(A, I) {
        const g = I(1 * A.length);
        return w().set(A, g / 1),
        M = A.length,
        g
    }
    class U {
        ...
        free() {
            ...
            g.__wbg_jsvirtualfile_free(A);
        }
        lastAccessed() {
            const A = g.jsvirtualfile_lastAccessed(this.ptr);
            return BigInt.asUintN(64, A)
        }
        lastModified() {
            const A = g.jsvirtualfile_lastModified(this.ptr);
            return BigInt.asUintN(64, A)
        }
        createdTime() {
            const A = g.jsvirtualfile_createdTime(this.ptr);
            return BigInt.asUintN(64, A)
        }
        size() {
            const A = g.jsvirtualfile_size(this.ptr);
            return BigInt.asUintN(64, A)
        }
        setLength(A) {
            try {
                const B = g.__wbindgen_add_to_stack_pointer(-16);
                g.jsvirtualfile_setLength(B, this.ptr, A);
                var I = h()[B / 4 + 0];
                if (h()[B / 4 + 1])
                    throw G(I)
            } finally {
        ...
        read() {
            try {
                ...
                g.jsvirtualfile_read(C, this.ptr);
                var A = h()[C / 4 + 0]
                  , I = h()[C / 4 + 1]
                  , B = h()[C / 4 + 2];
                if (h()[C / 4 + 3])
                    throw G(B);
                var Q = c(A, I).slice();
                return g.__wbindgen_free(A, 1 * I),
                Q
            } finally {
                g.__wbindgen_add_to_stack_pointer(16);
            }
        ...
        readString() {
            try {
                ...
                g.jsvirtualfile_readString(D, this.ptr);
                var A = h()[D / 4 + 0]
                  , I = h()[D / 4 + 1]
                  , B = h()[D / 4 + 2]
                  , Q = h()[D / 4 + 3]
                ...
                g.__wbindgen_add_to_stack_pointer(16),
                g.__wbindgen_free(C, E);
            }
        }
        write(A) {
            try {
                const E = g.__wbindgen_add_to_stack_pointer(-16);
                var I = K(A, g.__wbindgen_malloc)
                  , B = M;
                g.jsvirtualfile_write(E, this.ptr, I, B);
                var Q = h()[E / 4 + 0]
                  , C = h()[E / 4 + 1];
                if (h()[E / 4 + 2])
                    throw G(C);
                ...
                g.__wbindgen_add_to_stack_pointer(16),
                A.set(w().subarray(I / 1, I / 1 + B)),
                g.__wbindgen_free(I, 1 * B);
            }
        }
        writeString(A) {
            try {
                const Q = g.__wbindgen_add_to_stack_pointer(-16)
                  , C = Y(A, g.__wbindgen_malloc, g.__wbindgen_realloc)
                  , E = M;
                g.jsvirtualfile_writeString(Q, this.ptr, C, E);
                var I = h()[Q / 4 + 0]
                  , B = h()[Q / 4 + 1];
                if (h()[Q / 4 + 2])
                    throw G(B);
        ...
        flush() {
            try {
                ...
                g.jsvirtualfile_flush(I, this.ptr);
                var A = h()[I / 4 + 0];
                if (h()[I / 4 + 1])
                    throw G(A)
            } finally {
        ...
        seek(A) {
            try {
                const Q = g.__wbindgen_add_to_stack_pointer(-16);
                g.jsvirtualfile_seek(Q, this.ptr, A);
                var I = h()[Q / 4 + 0]
                  , B = h()[Q / 4 + 1];
                if (h()[Q / 4 + 2])
                    throw G(B);
    ...
    class S {
        ...
        readDir(A) {
            try {
                const Q = g.__wbindgen_add_to_stack_pointer(-16)
                  , C = Y(A, g.__wbindgen_malloc, g.__wbindgen_realloc)
                  , E = M;
                g.memfs_readDir(Q, this.ptr, C, E);
                var I = h()[Q / 4 + 0]
                  , B = h()[Q / 4 + 1];
                if (h()[Q / 4 + 2])
                    throw G(B);
        ...
        createDir(A) {
            try {
                const B = g.__wbindgen_add_to_stack_pointer(-16)
                  , Q = Y(A, g.__wbindgen_malloc, g.__wbindgen_realloc)
                  , C = M;
                g.memfs_createDir(B, this.ptr, Q, C);
                var I = h()[B / 4 + 0];
                if (h()[B / 4 + 1])
                    throw G(I)
            } finally {
        ...
        removeDir(A) {
            try {
                const B = g.__wbindgen_add_to_stack_pointer(-16)
                  , Q = Y(A, g.__wbindgen_malloc, g.__wbindgen_realloc)
                  , C = M;
                g.memfs_removeDir(B, this.ptr, Q, C);
                var I = h()[B / 4 + 0];
                if (h()[B / 4 + 1])
                    throw G(I)
            } finally {
        ...
        removeFile(A) {
            try {
                const B = g.__wbindgen_add_to_stack_pointer(-16)
                  , Q = Y(A, g.__wbindgen_malloc, g.__wbindgen_realloc)
                  , C = M;
                g.memfs_removeFile(B, this.ptr, Q, C);
                var I = h()[B / 4 + 0];
                if (h()[B / 4 + 1])
                    throw G(I)
            } finally {
        ...
        rename(A, I) {
            try {
                const Q = g.__wbindgen_add_to_stack_pointer(-16)
                  , C = Y(A, g.__wbindgen_malloc, g.__wbindgen_realloc)
                  , E = M
                  , D = Y(I, g.__wbindgen_malloc, g.__wbindgen_realloc)
                  , i = M;
                g.memfs_rename(Q, this.ptr, C, E, D, i);
                var B = h()[Q / 4 + 0];
                if (h()[Q / 4 + 1])
                    throw G(B)
            } finally {
        ...
        metadata(A) {
            try {
                const Q = g.__wbindgen_add_to_stack_pointer(-16)
                  , C = Y(A, g.__wbindgen_malloc, g.__wbindgen_realloc)
                  , E = M;
                g.memfs_metadata(Q, this.ptr, C, E);
                var I = h()[Q / 4 + 0]
                  , B = h()[Q / 4 + 1];
                if (h()[Q / 4 + 2])
                    throw G(B);
        ...
        open(A, I) {
            try {
                const C = g.__wbindgen_add_to_stack_pointer(-16)
                  , D = Y(A, g.__wbindgen_malloc, g.__wbindgen_realloc)
                  , i = M;
                g.memfs_open(C, this.ptr, D, i, E(I));
                var B = h()[C / 4 + 0]
                  , Q = h()[C / 4 + 1];
                if (h()[C / 4 + 2])
                    throw G(Q);
    ...
    class s {
        ...
        getImports(A) {
            try {
                const Q = g.__wbindgen_add_to_stack_pointer(-16);
                g.wasi_getImports(Q, this.ptr, E(A));
                var I = h()[Q / 4 + 0]
                  , B = h()[Q / 4 + 1];
                if (h()[Q / 4 + 2])
                    throw G(B);
        ...
        instantiate(A, I) {
            try {
                const C = g.__wbindgen_add_to_stack_pointer(-16);
                g.wasi_instantiate(C, this.ptr, E(A), F(I) ? 0 : E(I));
                var B = h()[C / 4 + 0]
                  , Q = h()[C / 4 + 1];
                if (h()[C / 4 + 2])
                    throw G(Q);
        ...
        start(A) {
            try {
                const Q = g.__wbindgen_add_to_stack_pointer(-16);
                g.wasi_start(Q, this.ptr, F(A) ? 0 : E(A));
                var I = h()[Q / 4 + 0]
                  , B = h()[Q / 4 + 1];
                if (h()[Q / 4 + 2])
                    throw G(B);
        ...
        getStdoutBuffer() {
            try {
                const C = g.__wbindgen_add_to_stack_pointer(-16);
                g.wasi_getStdoutBuffer(C, this.ptr);
                var A = h()[C / 4 + 0]
                  , I = h()[C / 4 + 1]
                  , B = h()[C / 4 + 2];
                if (h()[C / 4 + 3])
        ...
        getStdoutString() {
            try {
                const D = g.__wbindgen_add_to_stack_pointer(-16);
                g.wasi_getStdoutString(D, this.ptr);
                var A = h()[D / 4 + 0]
                  , I = h()[D / 4 + 1]
                  , B = h()[D / 4 + 2]
                  , Q = h()[D / 4 + 3]
        ...
        getStderrBuffer() {
            try {
                const C = g.__wbindgen_add_to_stack_pointer(-16);
                g.wasi_getStderrBuffer(C, this.ptr);
                var A = h()[C / 4 + 0]
                  , I = h()[C / 4 + 1]
                  , B = h()[C / 4 + 2];
                if (h()[C / 4 + 3])
        ...
        getStderrString() {
            try {
                const D = g.__wbindgen_add_to_stack_pointer(-16);
                g.wasi_getStderrString(D, this.ptr);
                var A = h()[D / 4 + 0]
                  , I = h()[D / 4 + 1]
                  , B = h()[D / 4 + 2]
                  , Q = h()[D / 4 + 3]
        ...
        setStdinBuffer(A) {
            try {
                const B = g.__wbindgen_add_to_stack_pointer(-16)
                  , Q = K(A, g.__wbindgen_malloc)
                  , C = M;
                g.wasi_setStdinBuffer(B, this.ptr, Q, C);
                var I = h()[B / 4 + 0];
                if (h()[B / 4 + 1])
                    throw G(I)
            } finally {
        ...
        setStdinString(A) {
            try {
                const B = g.__wbindgen_add_to_stack_pointer(-16)
                  , Q = Y(A, g.__wbindgen_malloc, g.__wbindgen_realloc)
                  , C = M;
                g.wasi_setStdinString(B, this.ptr, Q, C);
                var I = h()[B / 4 + 0];
                if (h()[B / 4 + 1])
                    throw G(I)
            } finally {
    ...
    class L {
        ...
        free() {
            const A = this.__destroy_into_raw();
            g.__wbg_wasmerruntimeerror_free(A);
        }
        static __wbgd_downcast_token() {
    ...
    function H() {
        ...
        return A.wbg.__wbindgen_object_clone_ref = function(A) {
            return E(Q(A))
        }
        ,
        A.wbg.__wbg_crypto_e1d53a1d73fb10b8 = function(A) {
            return E(Q(A).crypto)
        }
        ,
        A.wbg.__wbg_process_038c26bf42b093f8 = function(A) {
            return E(Q(A).process)
        }
        ,
        A.wbg.__wbg_versions_ab37218d2f0b24a8 = function(A) {
            return E(Q(A).versions)
        }
        ,
        A.wbg.__wbg_node_080f4b19d15bc1fe = function(A) {
            return E(Q(A).node)
        }
        ,
        A.wbg.__wbindgen_is_string = function(A) {
            return "string" == typeof Q(A)
        }
        ,
        A.wbg.__wbg_require_78a3dcfbdba9cbce = function() {
            return R((function() {
        ...
        A.wbg.__wbg_call_168da88779e35f61 = function() {
            return R((function(A, I, g) {
                return E(Q(A).call(Q(I), Q(g)))
            }
            ), arguments)
        }
        ,
        A.wbg.__wbg_msCrypto_6e7d3e1f92610cbb = function(A) {
            return E(Q(A).msCrypto)
        }
        ,
        A.wbg.__wbg_newwithlength_f5933855e4f48a19 = function(A) {
            return E(new Uint8Array(A >>> 0))
        }
        ,
        ...
        ,
        A.wbg.__wbg_get_57245cc7d7c7619d = function(A, I) {
            return E(Q(A)[I >>> 0])
        }
        ,
        A.wbg.__wbg_call_97ae9d8645dc388b = function() {
            return R((function(A, I) {
                return E(Q(A).call(Q(I)))
            }
            ), arguments)
        }
        ,
        A.wbg.__wbg_self_6d479506f72c6a71 = function() {
            return R((function() {
                return E(self.self)
            }
            ), arguments)
        ...
        ,
        A.wbg.__wbg_window_f2557cc78490aceb = function() {
            return R((function() {
        ...
        ,
        A.wbg.__wbg_globalThis_7f206bda628d5286 = function() {
            return R((function() {
        ...
        ,
        A.wbg.__wbg_global_ba75c50d1cf384f4 = function() {
            return R((function() {
        ...
        ,
        A.wbg.__wbg_newnoargs_b5b063fc6c2f0376 = function(A, I) {
            return E(new Function(o(A, I)))
        }
        ,
        A.wbg.__wbg_instanceof_Function_056d5b3aef8aaa85 = function(A) {
            let I;
            try {
                I = Q(A)instanceof Function;
            } catch {
                I = !1;
            }
            return I
        ...
        ,
        A.wbg.__wbg_subarray_58ad4efbb5bcb886 = function(A, I, g) {
            return E(Q(A).subarray(I >>> 0, g >>> 0))
        }
        ,
        A.wbg.__wbindgen_is_function = function(A) {
            return "function" == typeof Q(A)
        }
        ,
        ...
        ,
        A.wbg.__wbg_instanceof_Module_09da91721979648d = function(A) {
            let I;
            try {
                I = Q(A)instanceof WebAssembly.Module;
            } catch {
                I = !1;
            }
            return I
        ...
        ,
        A.wbg.__wbg_instanceof_Table_aab62205c7444b79 = function(A) {
            let I;
            try {
                I = Q(A)instanceof WebAssembly.Table;
            } catch {
                I = !1;
            }
            return I
        ...
        ,
        A.wbg.__wbg_get_19328b9e516e0330 = function() {
            return R((function(A, I) {
                return E(Q(A).get(I >>> 0))
            }
            ), arguments)
        }
        ,
        A.wbg.__wbg_instanceof_Memory_f1dc0d9a83a9c8ea = function(A) {
            let I;
            try {
                I = Q(A)instanceof WebAssembly.Memory;
            } catch {
                I = !1;
            }
            return I
        ...
        ,
        A.wbg.__wbg_get_765201544a2b6869 = function() {
            return R((function(A, I) {
                return E(Reflect.get(Q(A), Q(I)))
            }
            ), arguments)
        }
        ,
        A.wbg.__wbg_getPrototypeOf_c046822345b14263 = function() {
            return R((function(A) {
                return E(Reflect.getPrototypeOf(Q(A)))
            }
            ), arguments)
        }
        ,
        A.wbg.__wbg_set_bf3f89b92d5a34bf = function() {
            return R((function(A, I, g) {
                return Reflect.set(Q(A), Q(I), Q(g))
            }
            ), arguments)
        }
        ,
        A.wbg.__wbindgen_debug_string = function(A, I) {
            const B = Y(N(Q(I)), g.__wbindgen_malloc, g.__wbindgen_realloc)
              , C = M;
            h()[A / 4 + 1] = C,
            h()[A / 4 + 0] = B;
        }
        ...
        A.wbg.__wbindgen_throw = function(A, I) {
            throw new Error(o(A, I))
        }
        ,
        A.wbg.__wbindgen_rethrow = function(A) {
            throw G(A)
        }
        ,
        A.wbg.__wbindgen_is_symbol = function(A) {
            return "symbol" == typeof Q(A)
        }
        ,
        A.wbg.__wbg_static_accessor_SYMBOL_45d4d15e3c4aeb33 = function() {
            return E(Symbol)
        }
        ,
        A.wbg.__wbindgen_jsval_eq = function(A, I) {
            return Q(A) === Q(I)
        }
        ,
        A.wbg.__wbg_newwithbyteoffsetandlength_d9aa266703cb98be = function(A, I, g) {
            return E(new Uint8Array(Q(A),I >>> 0,g >>> 0))
        }
        ,
        A.wbg.__wbindgen_string_get = function(A, I) {
            const B = Q(I)
              , C = "string" == typeof B ? B : void 0;
            var E = F(C) ? 0 : Y(C, g.__wbindgen_malloc, g.__wbindgen_realloc)
              , D = M;
            h()[A / 4 + 1] = D,
            h()[A / 4 + 0] = E;
        }
        ,
        A.wbg.__wbg_imports_5d97b92618ae2b69 = function(A) {
            return E(WebAssembly.Module.imports(Q(A)))
        }
        ,
        A.wbg.__wbg_length_6e3bbe7c8bd4dbd8 = function(A) {
            return Q(A).length
        }
        ,
        A.wbg.__wbg_instanceof_Global_6ae38baa556a9042 = function(A) {
            let I;
            try {
                I = Q(A)instanceof WebAssembly.Global;
            } catch {
                I = !1;
            }
            return I
        ...
        ,
        A.wbg.__wbg_wasmerruntimeerror_new = function(A) {
            return E(L.__wrap(A))
        }
        ,
        A.wbg.__wbg_constructor_20fd216941fe9866 = function(A) {
            return E(Q(A).constructor)
        }
        ,
        A.wbg.__wbindgen_number_get = function(A, I) {
            const B = Q(I)
              , C = "number" == typeof B ? B : void 0;
            (0 === J.byteLength && (J = new Float64Array(g.memory.buffer)),
            J)[A / 8 + 1] = F(C) ? 0 : C,
            h()[A / 4 + 0] = !F(C);
        }
        ,
        A.wbg.__wbg_new0_a57059d72c5b7aee = function() {
            return E(new Date)
        }
        ,
        A.wbg.__wbg_getTime_cb82adb2556ed13e = function(A) {
            return Q(A).getTime()
        }
        ,
        A.wbg.__wbg_getTimezoneOffset_89bd4275e1ca8341 = function(A) {
            return Q(A).getTimezoneOffset()
        }
        ,
        A.wbg.__wbg_new_0b9bfdd97583284e = function() {
            return E(new Object)
        }
        ,
        A.wbg.__wbindgen_bigint_from_u64 = function(A) {
            return E(BigInt.asUintN(64, A))
        }
        ,
        A.wbg.__wbg_new_1d9a920c6bfc44a8 = function() {
            return E(new Array)
        }
        ,
        A.wbg.__wbg_new_8d2af00bc1e329ee = function(A, I) {
            return E(new Error(o(A, I)))
        }
        ,
        A.wbg.__wbg_push_740e4b286702d964 = function(A, I) {
            return Q(A).push(Q(I))
        }
        ,
        ...
        ,
        A.wbg.__wbg_instanceof_Object_595a1007518cbea3 = function(A) {
            let I;
            try {
                I = Q(A)instanceof Object;
            } catch {
                I = !1;
            }
            return I
        ...
        ,
        A.wbg.__wbg_exports_1f32da4bc6734cea = function(A) {
            return E(Q(A).exports)
        }
        ,
        A.wbg.__wbg_exports_4db28c393be16bc5 = function(A) {
            return E(WebAssembly.Module.exports(Q(A)))
        }
        ,
        A.wbg.__wbindgen_typeof = function(A) {
            return E(typeof Q(A))
        }
        ,
        A.wbg.__wbg_isArray_27c46c67f498e15d = function(A) {
            return Array.isArray(Q(A))
        }
        ,
        A.wbg.__wbg_entries_65a76a413fc91037 = function(A) {
            return E(Object.entries(Q(A)))
        }
        ,
        A.wbg.__wbg_instanceof_Instance_b0fc12339921a27e = function(A) {
            let I;
            try {
                I = Q(A)instanceof WebAssembly.Instance;
            } catch {
                I = !1;
            }
            return I
        ...
        ,
        A.wbg.__wbg_new_1c5d2ff1edfe6d73 = function() {
            return R((function(A, I) {
                return E(new WebAssembly.Instance(Q(A),Q(I)))
            }
            ), arguments)
        }
        ,
        A.wbg.__wbg_newwithlength_7c42f7e738a9d5d3 = function(A) {
            return E(new Array(A >>> 0))
        }
        ,
        A.wbg.__wbg_apply_75f7334893eef4ad = function() {
            return R((function(A, I, g) {
                return E(Reflect.apply(Q(A), Q(I), Q(g)))
            }
            ), arguments)
        }
        ,
        A.wbg.__wbindgen_function_table = function() {
        ...
        ,
        A.wbg.__wbg_bind_10dfe70e95d2a480 = function(A, I, g, B) {
            return E(Q(A).bind(Q(I), Q(g), Q(B)))
        }
        ,
        A.wbg.__wbg_randomFillSync_6894564c2c334c42 = function() {
            return R((function(A, I, g) {
                Q(A).randomFillSync(c(I, g));
            }
            ), arguments)
        }
        ,
        A.wbg.__wbg_getRandomValues_805f1c3d65988a5a = function() {
            return R((function(A, I) {
                Q(A).getRandomValues(Q(I));
            }
            ), arguments)
        }
        ,
    ...
    async function d(A) {
        void 0 === A && (A = new URL("wasmer_wasi_js_bg.wasm",(typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('browser.umd.js',document.baseURI).href))));
        const I = H();
    ...
    function Z(A) {
        ...
        for (var g = A.substring(5, I).split(";"), B = "", Q = !1, C = g[0] || "text/plain", E = C, D = 1; D < g.length; D++)
            "base64" === g[D] ? Q = !0 : (E += ";".concat(g[D]),
            0 === g[D].indexOf("charset=") && (B = g[D].substring(8)));
        g[0] || B.length || (E += ";charset=US-ASCII",
        B = "US-ASCII");
        var i = Q ? "base64" : "ascii"
          , w = unescape(A.substring(I + 1))
          , o = Buffer.from(w, i);
        return o.type = C,
        o.typeFull = E,
        o.charset = B,
    ...
    class RubyVM {
        constructor() {
            ...
            const proxyExports = (exports)=>{
                const excludedMethods = ["addToImports", "instantiate", "rbSetShouldProhibitRewind", "rbGcDisable", "rbGcEnable", ];
            ...
            addRbJsAbiHostToImports(imports, proxyImports({
                ...
                jsValueToInteger(value) {
                    if (typeof value === "number") {
                        ...
                        return {
                            tag: "bignum",
                            val: BigInt(value).toString(10) + "\0"
                        };
        ...
        format(error, vm, privateObject) {
            const [zeroLiteral,oneLiteral,newLineLiteral] = (()=>{
                if (this.literalsCache == null) {
                    const zeroOneNewLine = [evalRbCode(vm, privateObject, "0"), evalRbCode(vm, privateObject, "1"), evalRbCode(vm, privateObject, `"\n"`), ];
            ...
            return this.formatString(error.call("class").toString(), error.toString(), [firstLine.toString(), restLines.toString(), ]);
        }
